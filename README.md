# Hotel-booking
Hotel booking system developed using PHP &amp; MySQL with features like room listing, booking management, and responsive UI.

A user-friendly hotel booking web application built to simplify room reservation and management.

# Hotel Booking System

A hotel booking web application that allows users to browse rooms, check availability, and make bookings easily.
